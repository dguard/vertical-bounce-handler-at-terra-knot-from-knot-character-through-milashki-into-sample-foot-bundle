...
* и knot-cubic растёт снизу \вверх \ выталкивая head \ above \

* \

* а между двумя knot-cubic нет \ предопределённого перехода \  \  computd перехода \

* \

* это уже сделано в allocatd \

* теперь \ into knot-cubic нужно сделать wrap stickd paper с защитой от прозрачных пикселей \

* \

* в других местах knot-cubic пока не подняли \

* так чел \ есть knot-cubic и мы его подняли выше \

* \

* and we \ православные католические англичане \ с французскими вервями \ 

* relesd 59 lines due to violation uk rf \
